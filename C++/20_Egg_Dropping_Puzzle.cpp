 ...
 * break, that means it will be a floor above the current floor which we a looking at. Hence, we call for solve(N,k-curFloor). We need to
 * return the max of these two calls, since we are looking for the highest floor. Also, of all the floors from 1 to k, we need to return
